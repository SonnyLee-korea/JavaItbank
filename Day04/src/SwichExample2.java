...
public class SwichExample2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("- 여행을 하고 싶은 계절이나 월을 입력하세요");
		System.out.print("> ");
		...
		case "3":case "4":case "5":case "봄":
			System.out.println("추천 여행지는 여의도 벚꽃 축제입니다");
			break;

		case "6":case "7":case "8":case "여름":
			System.out.println("추천 여행지는 부산입니다");
			break;
			
		case "9":case "10":case "11":case "가을":
			System.out.println("추천 여행지는 단풍 축제입니다");
			break;
		...
		case "12":case "1":case "2":case "겨울":
			...
			break;
		default:
			System.out.println("계절이나 월을 잘 못 입력하셨습니다.");
